...
which morphs into whatever you want during use.
...
and the program is then launched with the
menu entry updated to show it is installed.

The window-manager is also enhanced with
