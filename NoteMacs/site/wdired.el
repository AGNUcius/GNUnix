;;; TOUCHED for scamE:
;; return, C-m and C-j now call `wdired-finish-edit'
;; C-o unbound for global use as `ffap'
...
(unless wdired-mode-map
  ...
  (define-key wdired-mode-map "\e" 'wdired-abort-changes)
  (define-key wdired-mode-map "\C-c\C-[" 'wdired-abort-changes)
  (define-key wdired-mode-map [return]   'wdired-finish-edit)
  (define-key wdired-mode-map "\C-j"     'wdired-finish-edit)
  (define-key wdired-mode-map "\C-m"     'wdired-finish-edit)
