...
;; Created:  15-Mar-2001
;; Version:  0.4
;; Keywords: rfc, view, ietf
;; X-URL:    http://www.neilvandyke.org/rfcview/
;; X-RCS:    $Id: rfcview.el,v 1.22 2002/02/26 06:36:52 nwv Exp $ GMT
...
;; [Version 0.4, 26-Feb-2002, nwv@neilvandyke.org]
...
;;
;; [Version 0.3, 22-Feb-2002, nwv@neilvandyke.org]
;; * Added autoload cookie (suggested by Daniel Pittman).

;; [Version 0.2, 22-Feb-2002, nwv@neilvandyke.org]
...
;; [Version 0.1, 17-Mar-2001, nwv@neilvandyke.org] Initial release.  Note that
;; there's some hyperlink-related code, but it's not finished, so pretend it's
;; not there -- but the static reformatting stuff works and is useful, and I
;; can't spend any more time on this package in the near future, so I'm
;; releasing the package now.
